...
public class NurseryStockMapperImpl implements NurseryStockMapper {
    ...
    @Override
    public List<NurseryStockDTO> toDto(List<NurseryStock> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<NurseryStockDTO> list = new ArrayList<NurseryStockDTO>( entityList.size() );
        for ( NurseryStock nurseryStock : entityList ) {
            list.add( toDto( nurseryStock ) );
        }
