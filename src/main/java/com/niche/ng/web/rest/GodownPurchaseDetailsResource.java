...
public class GodownPurchaseDetailsResource {
    ...
    public GodownPurchaseDetailsResource(GodownPurchaseDetailsService godownPurchaseDetailsService) {
    ...
    @Timed
    public ResponseEntity<List<GodownPurchaseDetailsDTO>> getAllGodownPurchaseDetails(Pageable pageable) {
        log.debug("REST request to get a page of GodownPurchaseDetails");
        Page<GodownPurchaseDetailsDTO> page = godownPurchaseDetailsService.findAll(pageable);
