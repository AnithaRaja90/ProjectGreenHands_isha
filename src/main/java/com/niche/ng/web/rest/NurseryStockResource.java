...
public class NurseryStockResource {
    ...
    public NurseryStockResource(NurseryStockService nurseryStockService) {
    ...
    @Timed
    public ResponseEntity<List<NurseryStockDTO>> getAllNurseryStocks(Pageable pageable) {
        log.debug("REST request to get a page of NurseryStocks");
        Page<NurseryStockDTO> page = nurseryStockService.findAll(pageable);
