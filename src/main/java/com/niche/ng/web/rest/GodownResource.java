...
public class GodownResource {
    ...
    public GodownResource(GodownService godownService) {
    ...
    @GetMapping("/godowns")
    @Timed
    public ResponseEntity<List<GodownDTO>> getAllGodowns(Pageable pageable) {
        log.debug("REST request to get a page of Godowns");
        Page<GodownDTO> page = godownService.findAll(pageable);
