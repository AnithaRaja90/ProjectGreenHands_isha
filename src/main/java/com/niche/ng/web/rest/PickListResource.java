...
public class PickListResource {
    ...
    public PickListResource(PickListService pickListService) {
    ...
    @Timed
    public ResponseEntity<List<PickListDTO>> getAllPickLists(Pageable pageable) {
        log.debug("REST request to get a page of PickLists");
        Page<PickListDTO> page = pickListService.findAll(pageable);
