...
public class DamageResource {
    ...
    public DamageResource(DamageService damageService) {
    ...
    @GetMapping("/damages")
    @Timed
    public ResponseEntity<List<DamageDTO>> getAllDamages(Pageable pageable) {
        log.debug("REST request to get a page of Damages");
        Page<DamageDTO> page = damageService.findAll(pageable);
