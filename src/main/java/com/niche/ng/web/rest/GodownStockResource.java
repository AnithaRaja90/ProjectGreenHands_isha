...
public class GodownStockResource {
    ...
    public GodownStockResource(GodownStockService godownStockService) {
    ...
    @Timed
    public ResponseEntity<List<GodownStockDTO>> getAllGodownStocks(Pageable pageable) {
        log.debug("REST request to get a page of GodownStocks");
        Page<GodownStockDTO> page = godownStockService.findAll(pageable);
