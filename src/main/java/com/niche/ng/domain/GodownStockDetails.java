...
public class GodownStockDetails implements Serializable {
    ...
    public GodownStockDetails createdBy(Long createdBy) {
    ...
    public GodownStockDetails modifiedBy(Long modifiedBy) {
    ...
    public GodownStockDetails createdAt(Instant createdAt) {
    ...
    public GodownStockDetails updatedAt(Instant updatedAt) {
